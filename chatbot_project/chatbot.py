...
def check_all_messages(message, full_msg):
    ...
    # Custom FAQs
    response('My name is Prasana, your friendly assistant.', ['your', 'name'], required_words=['name'])
    response('I was created by Prasana ', ['who', 'made', 'you'], required_words=['who', 'made'])
...
if __name__ == '__main__':
    print("ChatBot : Hi there! I’m Prasana. Ask me anything, or type 'bye' to exit.")
    while True:
